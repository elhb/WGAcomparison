...
for sample in sbatchInfo:
    ...
    sbatchInfo[sample]['merging']['file'].write(
        ...
        'java -Xmx24g -jar $picard/CalculateHsMetrics.jar BAIT_INTERVALS=references/AgilentSureSelectHumanAllExonV4/S03723314_Covered.bed TARGET_INTERVALS=references/AgilentSureSelectHumanAllExonV4/S03723314_Covered.bed INPUT=tasks/mapping/'+sample+'/'+sample+'.merged.bam OUTPUT=tasks/mapping/'+sample+'/'+sample+'.hs_metrics.summary.txt PER_TARGET_COVERAGE=tasks/mapping/'+sample+'/'+sample+'.perTargetCov.txt REFERENCE_SEQUENCE=references/hg19/concat.fa\n'+
        'java -Xmx24g -jar $picard/CalculateHsMetrics.jar BAIT_INTERVALS=references/AgilentSureSelectHumanAllExonV4+UTRs/S03723424_Covered.bed TARGET_INTERVALS=references/AgilentSureSelectHumanAllExonV4+UTRs/S03723424_Covered.bed INPUT=tasks/mapping/'+sample+'/'+sample+'.merged.bam OUTPUT=tasks/mapping/'+sample+'/'+sample+'.hs_metrics.summary.+UTRs.txt PER_TARGET_COVERAGE=tasks/mapping/'+sample+'/'+sample+'.perTargetCov.+UTRs.txt REFERENCE_SEQUENCE=references/hg19/concat.fa\n'+
